    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-100 py-16 px-4">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-3xl p-10 text-gray-800">
        ...
        <p className="text-lg mb-6 leading-relaxed">
          Welcome to <span className="font-semibold text-emerald-600">Mr. Weblog</span> — your trusted hub for the latest in tech, development, and digital trends.
        ...
        <p className="text-lg mb-6 leading-relaxed">
          ...
          We also value <span className="italic text-emerald-700">community</span> — so feel free to reach out, ask questions, or suggest topics you'd like us to cover.
        </p>

        <p className="text-xl font-bold text-center text-emerald-600 mt-10">
